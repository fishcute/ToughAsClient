...
public class CursedFlameParticle extends AbstractSlowingParticle {
    private CursedFlameParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
    ...
    public static class CustomParticleFactory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            CursedFlameParticle flameParticle = new CursedFlameParticle(clientWorld, d, e, f, g, h, i);
